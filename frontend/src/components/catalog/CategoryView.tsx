...
import { CATEGORIES, slugify, type CardActions, type CatalogApp } from "@/lib/types";
import { AppIcon } from "./AppIcon";

type CategoryViewProps = CardActions & { apps: CatalogApp[] };

// Mode 4 — Category: apps grouped under their business/technical function.
  ...
  return (
    <div className="pb-6">
      {groups.map(({ category, items }) => (
        <section
          key={category}
          id={`category-section-${slugify(category)}`}
